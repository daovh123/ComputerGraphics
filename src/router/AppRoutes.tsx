...
export default function AppRoutes({
  ...
  const lessonModeRoutes = LESSON_ROUTES.filter((route) => route.chrome === "lesson");
  ...
  <Route
      ...
      <Route path="/lesson-31/anatomy" element={<Lesson31Module initialTab="anatomy" />} />
      <Route
        path="/lesson-31/movement-function"
        element={<Lesson31Module initialTab="movement-function" />}
      />
      <Route path="/lesson-31/diseases" element={<Lesson31Module initialTab="diseases" />} />
      <Route path="/lesson-31/model3d" element={<Lesson31Module initialTab="model3d" />} />
      <Route path="/lesson-31/quiz" element={<Lesson31Module initialTab="quiz" />} />
      <Route path="/lesson-31/summary" element={<Lesson31Module initialTab="summary" />} />
      ...
      {/* Preserve existing "lesson mode" routes (e.g. /lesson-33/learn/*) */}
      {lessonModeRoutes.map((route) => (
