...
export default function Lesson32Simulation() {
  ...
  const [activeTab, setActiveTab] = useState<"steps" | "game">("steps");
  ...
  return (
    <div className="space-y-6">
      {/* Tab Switcher */}
      <div className="bg-white border border-[#E0F0FF] rounded-3xl p-8 shadow-sm">
          ...
          <div className="space-y-6">
            <div>
              ...
              <p className="text-[#5B6470] text-sm leading-relaxed mt-2">
                Theo dõi hành trình thức ăn theo từng bước để thấy rõ: cơ học,
                hóa học, hấp thu và vai trò hỗ trợ tiêu hóa.
              </p>
            </div>
