  ...
  return (
    <div className="space-y-8">
      ...
      <div className="bg-white rounded-[40px] p-8 md:p-12 border border-[#E0F0FF] shadow-sm relative overflow-hidden group">
        <div className="absolute top-0 right-0 w-[600px] h-[600px] bg-red-50 rounded-full translate-x-1/3 -translate-y-1/3 group-hover:scale-110 transition-transform duration-700 pointer-events-none"></div>
        ...
        <div className="flex flex-col md:flex-row gap-12 relative z-10">
          <div className="flex-1 space-y-8">
            <div className="inline-flex items-center gap-2 px-4 py-2 bg-red-100 rounded-full text-red-600 font-bold text-sm">
              <Droplet className="w-4 h-4" />
              <span>Dòng chảy sự sống</span>
            </div>
            ...
            <div className="flex flex-wrap items-center gap-4">
              <button 
                onClick={() => setCurrentView("lesson-33-explorer" as View)}
          ...
          <div className="flex-[0.8] relative aspect-square md:aspect-auto">
            <div className="absolute inset-0 bg-gradient-to-tr from-red-500 to-blue-500 rounded-[32px] rotate-3 opacity-20 group-hover:rotate-6 transition-transform"></div>
              ...
              <div className="w-full h-full bg-[#1a1a1a] rounded-2xl overflow-hidden relative">
                ...
                <div className="absolute inset-x-0 bottom-0 h-32 bg-gradient-to-t from-black/80 to-transparent flex flex-col justify-end p-6 pointer-events-none">
                  <div className="text-white space-y-1">
                    <p className="font-bold text-lg">Mạng lưới tuần hoàn 3D</p>
                    <p className="text-sm text-white/80">Interactive Complete System</p>
                  </div>
                </div>
          ...
          <div className="space-y-4 relative z-10">
            ...
            >
              <div className="flex items-center gap-3">
                ...
                <div className="text-left">
                  <p className="font-bold text-white">Mô hình 3D Trái tim</p>
                  <p className="text-sm text-white/50">Khám phá cấu tạo tĩnh</p>
                </div>
              </div>
            ...
            >
              <div className="flex items-center gap-3">
                ...
                <div className="text-left">
                  <p className="font-bold text-white">Cấu tạo Máu</p>
                  <p className="text-sm text-white/50">Tế bào máu & Huyết tương</p>
                </div>
              </div>
              <ChevronRight className="w-5 h-5 text-white/30 group-hover/btn:text-white transition-colors" />
            </button>
